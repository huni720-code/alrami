      ...
      <div className="space-y-5 text-[14px] text-gray-600 leading-relaxed pb-12">
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>이메일 주소 (회원 식별·알림 발송용)</li>
            <li>이름·전화번호 (알림 수신용, 선택)</li>
            <li>약정 정보 (만료 추적 서비스 제공용)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            개인정보는 회원 탈퇴 시까지 보유하며, 탈퇴 시 즉시 파기합니다.
            단, 관계 법령에 의해 보존이 필요한 경우 해당 기간 동안 보관합니다.
          </p>
        </section>

        <section>
          <h2 className="text-[15px] font-bold text-gray-800 mb-2">4. 제3자 제공</h2>
          <p>
        ...
        <section>
          <h2 className="text-[15px] font-bold text-gray-800 mb-2">5. 이용자 권리</h2>
          <p>
            이용자는 언제든지 자신의 개인정보를 조회·수정·삭제할 수 있으며,
            서비스 탈퇴를 통해 모든 정보를 삭제할 수 있습니다.
          </p>
        </section>

        <section>
          <h2 className="text-[15px] font-bold text-gray-800 mb-2">6. 문의</h2>
          <p>
